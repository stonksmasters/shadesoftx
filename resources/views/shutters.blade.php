...
<head>
    ...
    <title>Window Shutters | Austin, TX | Shades of Texas</title>
    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <p class="lead">Premium plantation shutters that add timeless elegance and superior light control to your Austin home.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=shutters') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/awning.jpg') }}" alt="Plantation shutters installation">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                <h2>Why Choose Window Shutters?</h2>
                <p>Plantation shutters are a premium window covering that delivers unmatched versatility, durability, and aesthetic appeal. Their adjustable louvers give you precise control over light and privacy while adding significant value to your home.</p>
                <p>Built to withstand Austin's heat and humidity, our shutters are available in durable wood, composite, and vinyl materials. They provide excellent insulation, reducing your energy costs while blocking UV rays that fade furniture and flooring.</p>
                <p>Shades of Texas custom measures and installs each shutter to ensure a perfect fit. With a wide range of colors and finishes, our shutters complement any décor style from traditional to contemporary.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Materials:</strong> Hardwood, Composite, Vinyl</li>
                    <li><strong>Louver Sizes:</strong> 2.5", 3.5", 4.5"</li>
                    <li><strong>Energy Efficiency:</strong> R-Value up to 3.6</li>
