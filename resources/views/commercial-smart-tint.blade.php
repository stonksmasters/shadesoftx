...
<head>
    ...
    <title>SmartTint | Austin, TX | Shades of Texas</title>
    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <h1>SmartTint</h1>
                <p class="lead">Transform conference rooms and offices with switchable privacy glass that changes from clear to opaque instantly.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=commercial-smart-tint') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/commercialawning.jpg') }}" alt="Commercial SmartTint switchable glass">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                <h2>Why Choose SmartTint?</h2>
                <p>SmartTint revolutionizes commercial spaces with instant privacy control. Conference rooms, executive offices, and medical facilities benefit from glass that switches from transparent to private with the flip of a switch or tap of an app.</p>
                <p>This PDLC technology eliminates the need for blinds or curtains while providing ADA-compliant privacy solutions. Control systems integrate with building automation for scheduled privacy modes or occupancy-based switching.</p>
                <p>Shades of Texas installs SmartTint film on existing glass or specifies pre-laminated smart glass for new construction. Our team handles electrical integration, control programming, and staff training for seamless operation.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Technology:</strong> PDLC Switchable Film/Glass</li>
                    <li><strong>Switch Speed:</strong> <100ms</li>
                    <li><strong>Controls:</strong> Switch, App, Building Automation</li>
