...
<head>
    ...
    <title>Window Blinds | Austin, TX | Shades of Texas</title>
    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <h1>Window Blinds</h1>
                <p class="lead">Versatile and affordable window blinds offering classic style and practical light control for Austin homes.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=blinds') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/awning.jpg') }}" alt="Custom window blinds">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                ...
                <p>Window blinds remain one of the most popular and practical window treatments for Austin homeowners. From classic horizontal blinds to modern vertical options, blinds provide excellent light control, privacy, and affordability.</p>
                <p>Our selection includes wood blinds for warmth and elegance, aluminum blinds for durability and value, and faux wood blinds that resist moisture and warping in Texas humidity. All options deliver UV protection and energy efficiency.</p>
                <p>Shades of Texas offers professional installation with custom sizing to fit any window perfectly. Choose from cordless, motorized, or traditional lift systems for safety and convenience.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Materials:</strong> Wood, Faux Wood, Aluminum</li>
                    <li><strong>Slat Sizes:</strong> 1", 2", 2.5"</li>
                    <li><strong>Operation:</strong> Cordless, Motorized, Traditional</li>
                    <li><strong>Warranty:</strong> Manufacturer Limited</li>
                </ul>
            </div>
        </div>
    </section>
