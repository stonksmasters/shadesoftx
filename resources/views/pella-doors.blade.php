...
<head>
    ...
    <title>Pella® Doors | Austin, TX | Shades of Texas</title>
    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <h1>Pella® Doors</h1>
                <p class="lead">Premium entry and patio doors that combine security, energy efficiency, and stunning design for Austin homes.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=pella-doors') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/awning.jpg') }}" alt="Pella entry and patio doors">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                <h2>Why Choose Pella® Doors?</h2>
                <p>Pella® doors make a powerful first impression while providing superior security and insulation. From elegant entry doors to expansive sliding patio doors, each Pella product is engineered for beauty and performance.</p>
                <p>Advanced weatherstripping and multi-point locking systems keep your home secure and energy efficient. Choose from fiberglass, steel, and wood materials with endless customization options including glass, hardware, and finish colors.</p>
                <p>Shades of Texas certified installers ensure proper fit and function, critical for Austin's temperature extremes. We handle everything from removal of old doors to final adjustments and cleanup.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Types:</strong> Entry, Patio, French, Sliding</li>
                    <li><strong>Materials:</strong> Fiberglass, Steel, Wood</li>
                    <li><strong>Security:</strong> Multi-point Lock Systems</li>
