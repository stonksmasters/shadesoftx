...
<head>
    ...
    <title>Patio Awnings | Austin, TX | Shades of Texas</title>
    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <h1>Patio Awnings</h1>
                <p class="lead">Commercial-grade awnings that expand outdoor dining areas and reduce energy costs for Austin businesses.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=commercial-awnings') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/commercialawning.jpg') }}" alt="Commercial patio awnings">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                <h2>Why Choose Patio Awnings?</h2>
                <p>Commercial awnings create comfortable outdoor spaces for restaurants, cafes, and retail establishments. Retractable or fixed awnings expand your usable square footage while protecting customers from Austin's intense sun and occasional rain.</p>
                <p>Our heavy-duty awnings reduce heat transfer through windows and doors, lowering HVAC costs by up to 25%. High-performance fabrics block UV rays, resist fading, and maintain vibrant colors for years. Add lighting integration for evening ambiance.</p>
                <p>Shades of Texas designs and installs commercial awnings that meet local building codes and wind load requirements. Choose from manual or motorized operation with wind sensors for automatic retraction during storms.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Types:</strong> Retractable, Fixed, Lateral Arm</li>
                    <li><strong>Fabric:</strong> Sunbrella, PVC-Coated</li>
                    <li><strong>Wind Rating:</strong> Up to 40 mph deployed</li>
                    <li><strong>Warranty:</strong> 5-10 Year Frame/Fabric</li>
                </ul>
            </div>
        </div>
    </section>
