...
<head>
    ...
    <title>Pella® Windows | Austin, TX | Shades of Texas</title>
    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <h1>Pella® Windows</h1>
                <p class="lead">Premium energy-efficient replacement windows that enhance your Austin home's comfort, value, and curb appeal.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=pella-windows') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/awning.jpg') }}" alt="Pella replacement windows">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                <h2>Why Choose Pella® Windows?</h2>
                <p>Pella® is America's most trusted window brand, offering superior energy efficiency, durability, and style. Our certified installers bring decades of experience to ensure your new windows perform flawlessly in Austin's challenging climate.</p>
                <p>With advanced Low-E glass technology and insulating argon gas fills, Pella windows reduce heat transfer by up to 50%, lowering your energy bills while increasing comfort. Choose from double-hung, casement, sliding, and specialty shapes in wood, vinyl, or fiberglass.</p>
                <p>As an authorized Pella dealer, Shades of Texas provides expert consultation, precise installation, and comprehensive warranty support. Enhance your home's beauty while protecting your investment.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Materials:</strong> Vinyl, Wood, Fiberglass</li>
                    <li><strong>Glass:</strong> Low-E, Triple Pane Options</li>
                    <li><strong>Energy Star:</strong> Certified for Texas</li>
