    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <h1>SmartTint</h1>
                <p class="lead">Transform any window from clear to private instantly with switchable smart glass technology for your Austin home.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=smart-tint') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/awning.jpg') }}" alt="SmartTint switchable privacy glass">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                ...
                <p>SmartTint is revolutionary switchable glass technology that instantly transforms from transparent to opaque with the flip of a switch or tap of an app. Perfect for bathrooms, home offices, and conference rooms where privacy matters.</p>
                <p>This cutting-edge solution eliminates the need for blinds or curtains while providing on-demand privacy and light control. The technology uses PDLC (Polymer Dispersed Liquid Crystal) to switch between states in milliseconds.</p>
                <p>Shades of Texas brings decades of installation expertise to ensure your SmartTint system performs flawlessly. We handle everything from electrical integration to app configuration.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Technology:</strong> PDLC Switchable Film</li>
                    <li><strong>Switch Time:</strong> <100ms</li>
                    <li><strong>Control Options:</strong> Switch, Remote, App</li>
                    <li><strong>Warranty:</strong> 5-Year Manufacturer</li>
                </ul>
            </div>
        </div>
    </section>
