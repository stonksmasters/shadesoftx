...
<head>
    ...
    <title>Window Shades | Austin, TX | Shades of Texas</title>
    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <h1>Window Shades</h1>
                <p class="lead">Elegant, custom window shades that provide light control, privacy, and energy efficiency for your Austin home.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=shades') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/awning.jpg') }}" alt="Custom window shades installation">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                <h2>Why Choose Window Shades?</h2>
                <p>Our custom window shades combine style and function, offering precise light control while enhancing your home's interior design. From cellular shades that insulate to roller shades that provide clean lines, we have options for every room.</p>
                <p>Window shades reduce heat gain during Austin's scorching summers and provide insulation during cooler months. They also protect your furniture and flooring from harmful UV rays while maintaining your view and natural light.</p>
                <p>Shades of Texas offers professional measurement and installation services, ensuring a perfect fit every time. Choose from manual or motorized options with smart home integration.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Styles:</strong> Cellular, Roller, Roman, Solar</li>
                    <li><strong>Operation:</strong> Manual, Cordless, Motorized</li>
                    <li><strong>UV Protection:</strong> Up to 99%</li>
                    <li><strong>Warranty:</strong> Manufacturer Limited Lifetime</li>
                </ul>
            </div>
        </div>
    </section>
