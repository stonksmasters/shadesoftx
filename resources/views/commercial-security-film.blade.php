    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <p class="lead">Protect your Austin business from break-ins, blast events, and severe weather with commercial-grade security film.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=commercial-security-film') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/commercialawning.jpg') }}" alt="Commercial security window film">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                ...
                <p>Commercial security film creates a nearly invisible barrier that holds glass together during forced entry attempts, bomb blasts, severe storms, and accidents. This critical layer protects occupants, assets, and your liability exposure.</p>
                <p>Our thickest films (8mil-15mil) meet government and military specifications for blast mitigation and forced entry deterrence. Even after glass shatters, the film holds fragments together, preventing dangerous projectiles and maintaining a barrier against intruders.</p>
                <p>Shades of Texas works with property managers, corporate security teams, and government facilities throughout Austin. We provide threat assessments, specification writing, and certified installation with anchor systems.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Film Thickness:</strong> 8mil to 15mil options</li>
                    <li><strong>Standards:</strong> GSA, DOS, ASTM certified</li>
                    <li><strong>Anchoring:</strong> Wet-glazed or mechanical</li>
                    <li><strong>Warranty:</strong> 10-Year Commercial</li>
                </ul>
            </div>
        </div>
    </section>
