...
<head>
    ...
    <title>Window Cleaning | Austin, TX | Shades of Texas</title>
    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <p class="lead">Professional window cleaning services that restore clarity and curb appeal to your Austin home.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=window-cleaning') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/awning.jpg') }}" alt="Professional window cleaning service">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                <h2>Why Choose Window Cleaning?</h2>
                <p>Clean windows transform your home's appearance and allow maximum natural light. Our professional window cleaning service removes dirt, pollen, hard water spots, and oxidation that accumulate on Austin windows.</p>
                <p>We use professional-grade tools and eco-friendly cleaning solutions to achieve streak-free results without damaging window tint, screens, or frames. Our trained technicians clean both interior and exterior surfaces, including hard-to-reach windows.</p>
                <p>Shades of Texas offers one-time deep cleaning or scheduled maintenance plans to keep your windows crystal clear year-round. We also clean screens, tracks, and sills for a complete refresh.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Services:</strong> Interior, Exterior, Screen Cleaning</li>
                    <li><strong>Methods:</strong> Squeegee, Water-Fed Pole</li>
                    <li><strong>Solutions:</strong> Eco-Friendly, Film-Safe</li>
                    <li><strong>Warranty:</strong> Satisfaction Guaranteed</li>
                </ul>
            </div>
        </div>
    </section>
