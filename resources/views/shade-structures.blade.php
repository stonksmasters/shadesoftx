...
<head>
    ...
    <title>Shade Structures | Austin, TX | Shades of Texas</title>
    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <p class="lead">Custom outdoor shade structures that expand your living space and provide relief from Austin's intense summer sun.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=shade-structures') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/awning.jpg') }}" alt="Custom shade structure for outdoor living">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                <h2>Why Choose Shade Structures?</h2>
                <p>Shade structures transform your outdoor space into a comfortable retreat from the Texas heat. From pergolas and gazebos to modern tension-fabric canopies, we design and install structures that combine function with architectural beauty.</p>
                <p>Our custom shade solutions block harmful UV rays while allowing airflow, creating comfortable outdoor living areas for dining, relaxation, or entertaining. Choose from retractable systems for flexibility or permanent installations for year-round shade.</p>
                <p>Shades of Texas works with premium materials including powder-coated aluminum, treated wood, and high-performance shade fabrics that resist fading and mildew in Austin's climate.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Types:</strong> Pergolas, Gazebos, Tension Canopies</li>
                    <li><strong>Materials:</strong> Aluminum, Wood, Composite</li>
