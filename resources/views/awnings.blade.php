    ...
    <section class="service-hero">
        <div class="container hero-flex">
            <div class="hero-text">
                ...
                <h1>Patio Awnings</h1>
                <p class="lead">Retractable and fixed awnings that reduce heat, protect furniture, and extend your outdoor living season in Austin.</p>
                <div class="cta-row">
                    <a href="{{ url('/booking?service=awnings') }}" class="btn btn-main">Book Free Estimate</a>
                    <a href="#details" class="btn btn-secondary">View Details</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="{{ asset('images/awning.jpg') }}" alt="Retractable patio awning installation">
            </div>
        </div>
    </section>
    ...
    <section id="details" class="details-section">
        <div class="container details-grid">
            <div class="details-content">
                ...
                <p>Patio awnings provide instant shade and comfort for your outdoor living spaces. Whether you choose retractable awnings for flexibility or fixed awnings for permanent coverage, you'll enjoy cooler temperatures and reduced glare.</p>
                <p>Our high-quality awnings block up to 98% of UV rays, protecting your family and outdoor furniture from sun damage. They also reduce heat transfer into your home, lowering cooling costs by up to 25% during Austin's hot summers.</p>
                <p>Shades of Texas offers motorized retractable awnings with wind and sun sensors, ensuring your investment is protected automatically. Choose from hundreds of fabric colors and patterns to complement your home's style.</p>
            </div>
            <div class="specs-box">
                <h4>Technical Details</h4>
                <ul class="specs-list">
                    <li><strong>Types:</strong> Retractable, Fixed, Motorized</li>
                    <li><strong>Fabric:</strong> Sunbrella, Solution-Dyed Acrylic</li>
                    <li><strong>UV Protection:</strong> Up to 98%</li>
                    <li><strong>Warranty:</strong> 5-10 Year Limited</li>
                </ul>
            </div>
        </div>
    </section>
